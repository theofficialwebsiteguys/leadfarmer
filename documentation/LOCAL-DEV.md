...
`docs/` in this repo is the GitHub Pages preview build — generated output, wiped
and rewritten by `npm run build:ghpages`. Never put anything you wrote in there.
